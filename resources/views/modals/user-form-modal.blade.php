...
#vehicle-images-slider img:hover {
  ...
  .modal-body {
    ...
    align-items: center;
    min-height: 60vh; /* adjust height to your liking */
    padding: 0 !important;
  }
</style>
            ...
            <div class="modal-body">
                <form id="user-update-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="vehicle-name" name="vehicle_name" placeholder="Enter Vehicle Name">
                    </div>

                    <div class="mb-3">
                        <label for="vehicle-no" class="form-label">Vehicle Number</label>
                        <input type="text" class="form-control" id="vehicle-no" name="vehicle_no" placeholder="Enter Vehicle Number">
                    </div>

                    <div class="mb-3">
                        <label for="vehicle-type" class="form-label">Vehicle Type</label>
                        <input type="text" class="form-control" id="vehicle-type" name="vehicle_type" placeholder="Enter Vehicle Type">
                    </div>

          <div class="mb-3">
            <label class="form-label">Vehicle Images</label>
            <div id="vehicle-images-slider" style="display: flex; overflow-x: auto; gap: 10px; padding: 10px; border: 1px solid #ccc; border-radius: 4px; max-height: 120px;">
            </div>
          </div>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Close modal when clicking outside the image inside modal body
