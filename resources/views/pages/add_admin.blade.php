        ...
        <div class="col-lg-7 col-xl-10 col-xxl-8">
            <div class="card custom-card">
                <form action="{{ route('admins.store') }}" method="POST" enctype="multipart/form-data" id="admin-form">
                    ...
                    <input type="hidden" name="profile_photo" id="photo-url">
                            ...
                            <div class="tab-pane show active fs-13 p-5" id="personal-info" role="tabpanel">
                                        ...
                                        <div class="mb-0 me-5 d-flex align-items-center justify-content-center">
                                            <span class="avatar-xl rounded-circle position-relative">
                                                ...
                                                <a href="javascript:void(0);" class="badge position-absolute rounded-pill bg-primary tx-fixed-white avatar-icons">
                                                    <input type="file" name="photo_file" accept="image/*" class="position-absolute w-100 h-100 op-0" id="profile-change">
                                ...
                                <div class="row gy-4 mb-4">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email-address" placeholder="xyz@gmail.com" required>
                                    </div>
                                </div>
                                <div class="row gy-4 mb-4">
                                    <div class="col-xl-6">
                                ...
                                <div class="row gy-4 mb-4">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control" id="confirmation_password" placeholder="Confirm Password" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
document.getElementById('profile-change').addEventListener('change', async function(event) {
    ...
    try {
        ...
        if (data.secure_url) {
            // Set uploaded image URL in hidden input
