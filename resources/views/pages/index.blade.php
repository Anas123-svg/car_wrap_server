                                ...
                                <div class="card bg-primary tx-fixed-white card-bg-img">
                                    <div class="card-body position-relative d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="mb-1 fs-13 op-8">You have got 5 new offers, Track here<br> the Sales
                                                data and best deals here.</p>
                                        ...
                                        <div class="min-w-fit-content">
                                            <span class="avatar avatar-xxl bg-transparent">
                                                <img src="{{asset('build/assets/images/png/6.png')}}" class="op-7"
                                                    alt="img">
                                            </span>
                                        </div>
                                    </div>
